...
const CustomizedDatagrid = props => {
    const {
        pageSize, page, columns, rows, pageChange, pageSizeChange, ...rest
    } = props;
    ...
    const CustomToolbar = props => {
        return (
            <GridToolbarContainer>
                ...
                <Box sx={{ flexGrow: 1 }} />
                <GridToolbarQuickFilter inputRef={textInput} />
            </GridToolbarContainer >
        );
    }
        ...
        >
            <DataGrid
                ...
                onPaginationModelChange={(e) => {
                    dispatch(pageSizeChange(e.pageSize))
                    dispatch(pageChange(e.page))
                }}
                components={{
